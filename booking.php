        ...
        <div class="bcontainer">
            <div class="cinemahalls">
                <div class="heading">
                    ...
                    ?>
                    <h2>Choose a Cinema Hall for <?php echo $row['mname']; ?></h2>
                </div>
                <div class="list">
                        <?php
                            ...
                            while($row=mysqli_fetch_array($rs)){
                                if(isset($_GET['chid'])){
                                    if($row['chid']==$schid){
                                    ?>
                                    <a href="booking.php?chid=<?php echo $row['chid']; ?>&mid=<?php echo $smid; ?>" style="color:#072227;border:yellow;"><h5><?php echo $row['chname']; ?></h5></a>
                            <?php
                                }
                            }
                            else{
                        ?>
                            <a href="booking.php?chid=<?php echo $row['chid']; ?>&mid=<?php echo $smid; ?>" style="color:#072227;"><h5><?php echo $row['chname']; ?></h5></a>
                        <?php }
                     } ?>
                </div>
            </div>
                ...
                <?php
                    ...
                    while($row=mysqli_fetch_array($rs)){
                        if(isset($_GET['time'])){
                            if($row['time']==$stime){
                ?>
                    <a href="booking.php?chid=<?php echo $schid; ?>&mid=<?php echo $smid; ?>&time=<?php echo $row['time']; ?>" style="color:#072227;border:none;"><h5><?php echo $row['time']; ?></h5></a>
                    <?php
                    }
                    }else{
                    ?>
                        <a href="booking.php?chid=<?php echo $schid; ?>&mid=<?php echo $smid; ?>&time=<?php echo $row['time']; ?>" style="color:#072227;"><h5><?php echo $row['time']; ?></h5></a>
                        <?php
                    }
                }
            }
            ...
            <div class="seats">
                ...
                <?php
                    ...
                    $sshid=$row['shid'];
                ?>
                    <a href="booking.php?chid=<?php echo $schid; ?>&mid=<?php echo $smid; ?>&time=<?php echo $stime; ?>" style="color:#072227;"><h5><?php echo $row['avseat']; ?></h5></a>
                    ...
                    ?>
                    <form action="booking.inc.php?shid=<?php echo $sshid; ?>&chid=<?php echo $schid; ?>&mid=<?php echo $smid; ?>&time=<?php echo $stime; ?>&avseat=<?php echo $savseat; ?>" method="POST">
