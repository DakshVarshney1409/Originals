...
<body>
    <div class="wrapper">
        ...
        <?php
            ...
            if(isset($_GET['cancel'])){
                if($_GET['cancel']=="success"){?>
                    <div class="toast" id="toast">
                    <?php echo "Booking cancelled successfully."; ?>
                    <span onclick="timer()" style="font-weight:600;cursor:pointer;color:#40D3DC;">&nbsp;&nbsp;&nbsp;&nbsp;X</span>
                </div>
             <?php   }
            }
                ...
                <div class="list">
                    <?php
                            while($row=mysqli_fetch_array($rs)){
                                $mid=$row['mid'];
                        ?>
                            <a href="moviepage.php?mid=<?php echo $mid; ?>"><div class="m">
                            <img class="movie-images" src="<?php echo $row['mimage']; ?>" alt="image">
        ...
        <div class="bookings" id="bookings">
            <?php
                $uid=$_SESSION["uid"];
                $sql="SELECT * FROM booking WHERE uid='$uid' AND visibility='1';";
                $rs=mysqli_query($con,$sql);
                while($row=mysqli_fetch_array($rs)){
            ...
            <div class="booking">
                    ...
                    <h4><?php echo "Rs. ".$row['seatsno']*$rowtic['ticketprice']; ?></h4>
                    <h4><?php echo $row['seatsno']." ticket"; ?></h4>
                    <h4><strong><?php echo $row['time']; ?></strong></h3>
                    <a href="cancel.inc.php?bid=<?php echo $row['bid']; ?>&shid=<?php echo $row['shid']; ?>&seatsno=<?php echo $row['seatsno']; ?>">
                        <div class="cancel">
        ...
        <div class="content">
            <div class="banner">
                <div class="slider">
                    <div class="slides">
                        ...
                        <div class="nav">
                            <label for="r1" class="btn btn1"></label>
                            <label for="r2" class="btn btn2"></label>
                            <label for="r3" class="btn btn3"></label>
                            <label for="r4" class="btn btn4"></label>
                        </div>
                    </div>
                </div>
            </div>
           ...
           <a href="#"><img src="Images/coming-soon.jpg" alt="coming-soon"></a>
            </div>
